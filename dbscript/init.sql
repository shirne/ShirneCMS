...
VALUES
  ...
  (6,2,'分类管理','Category/index','category_index','ion-md-medical',0,0),
  (7,2,'文章管理','Article/index','article_index','ion-md-paper',0,0),
  (8,2,'单页管理','Page/index','page_index','ion-md-document',0,0),
  (9,3,'公告管理','Notice/index','notice_index','ion-md-megaphone',0,0),
  (10,3,'广告管理','Adv/index','adv_index','ion-md-aperture',0,0),
  (11,3,'链接管理','Links/index','links_index','ion-md-link',0,0),
  (12,3,'留言管理','Feedback/index','feedback_index','ion-md-chatbubbles',0,0),
  (13,4,'会员管理','Member/index','member_index','ion-md-person',0,0),
  (14,4,'邀请码','Invite/index','invite_index','ion-md-pricetags',0,0),
  (15,4,'会员组','MemberLevel/index','member_level_index','ion-md-people',0,0),
  (16,4,'充值记录','Paylog/recharge','paylog_recharge','ion-md-log-in',0,0),
  (17,4,'提现记录','Paylog/cashin','paylog_cashin','ion-md-log-out',0,0),
  (18,4,'操作日志','Member/log','member_log','ion-md-clipboard',0,0),
  (19,5,'配置管理','Setting/index','setting_index','ion-md-options',0,0),
  (20,5,'管理员','Manager/index','manager_index','ion-md-person',0,0),
  (21,5,'菜单管理','Permission/index','permission_index','ion-md-code-working',0,0),
  (22,5,'操作日志','Manager/log','manager_log','ion-md-clipboard',0,0),
  (23,5,'付款方式','Paytype/index','paytype_index','ion-md-card',0,0);
