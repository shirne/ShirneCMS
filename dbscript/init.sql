...
VALUES
  ...
  ( 'appid', 'APPID', 'text', 'third', '0', '', '', ''),
  ( 'appsecret', 'APPSecret', 'text', 'third', '0', '', '', ''),
  ( 'token', 'Token', 'text', 'wechat', '0', '', '', ''),
  ( 'encodingaeskey', 'AES密钥', 'text', 'third', '0', '', '', ''),
  ( 'debug', '调试模式', 'radio', 'third', '0', '1', '', '1:开启\r\n2:关闭'),
  ( 'wechat_autologin', '自动登录', 'radio', 'third', '0', '1', '', '1:开启\r\n2:关闭'),
