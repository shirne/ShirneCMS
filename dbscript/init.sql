...
VALUES
  ...
  (4,'site-weblogo','站点logo','image','common',0,'','站点logo',''),
  (5,'site-tongji','统计代码','textarea','common',0,'','统计代码',''),
  (6,'site-icp','ICP备案号','text','common',0,'123456','ICP备案号',''),
  (7,'site-url','站点网址','text','common',0,'http://www.shirne.cn','站点地址',''),
  (8,'site-address','公司地址','text','common',0,'','公司地址',''),
  (9,'site-location','公司位置','location','common',0,'','location',''),
  (10, 'appid', 'APPID', 'text', 'third', '0', '', '', ''),
  (11, 'appsecret', 'APPSecret', 'text', 'third', '0', '', '', ''),
  (12, 'token', 'Token', 'text', 'wechat', '0', '', '', ''),
  (13, 'encodingaeskey', 'AES密钥', 'text', 'third', '0', '', '', ''),
  (14, 'debug', '调试模式', 'radio', 'third', '0', '1', '', '1:开启\r\n2:关闭'),
  (15, 'wechat_autologin', '自动登录', 'radio', 'third', '0', '1', '', '1:开启\r\n2:关闭'),
  ...
  (25, 'sms_code', '短信验证', 'radio', 'third', '0', '1', '', '1:开启\r\n2:关闭'),
  (26, 'sms_spcode', '企业编号', 'text', 'third', '0', '', '', ''),
  (27, 'sms_loginname', '登录名称', 'text', 'third', '0', '', '', ''),
  (28, 'sms_password', '登录密码', 'text', 'third', '0', '', '', ''),
  (29, 'kd_userid', '快递鸟用户ID', 'text', 'third', '0', '', '', ''),
  (30, 'kd_apikey', '快递鸟API Key', 'text', 'third', '0', '', '', ''),
