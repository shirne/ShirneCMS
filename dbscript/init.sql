...
VALUES
  ...
  (14,3,'公告管理','Notice/index','notice_index','ion-md-megaphone',0,0),
  (15,3,'广告管理','Adv/index','adv_index','ion-md-aperture',0,0),
  (16,3,'链接管理','Links/index','links_index','ion-md-link',0,0),
  (17,3,'留言管理','Feedback/index','feedback_index','ion-md-chatbubbles',0,0),
  (18,4,'会员管理','Member/index','member_index','ion-md-person',0,0),
  (19,4,'邀请码','Invite/index','invite_index','ion-md-pricetags',0,0),
  (20,4,'会员组','MemberLevel/index','member_level_index','ion-md-people',0,0),
  (21,4,'充值记录','Paylog/recharge','paylog_recharge','ion-md-log-in',0,0),
  (22,4,'提现记录','Paylog/cashin','paylog_cashin','ion-md-log-out',0,0),
  (23,4,'操作日志','Member/log','member_log','ion-md-clipboard',0,0),
  (24,5,'配置管理','Setting/index','setting_index','ion-md-options',0,0),
