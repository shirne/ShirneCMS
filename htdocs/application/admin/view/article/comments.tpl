        ...
        <table class="table table-hover table-striped">
            ...
            <foreach name="lists" item="v">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-outline-dark btn-sm" href="{:url('article/commentview',array('id'=>$v['id']))}"><i class="ion-edit"></i> 查看</a>
                        <a class="btn btn-outline-dark btn-sm" href="{:url('article/commentdelete',array('id'=>$v['id']))}" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');"><i class="ion-trash-a"></i> 删除</a>
                    </td>
                </tr>
            </foreach>
            </tbody>
