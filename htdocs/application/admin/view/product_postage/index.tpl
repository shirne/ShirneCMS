...
<block name="body">
    ...
    <include file="public/bread" menu="product_postage_index" title="运费模板列表" />

    <div id="page-wrapper">

        <div class="row list-header">
            <div class="col-6">
                <a href="{:url('ProductPostage/add')}" class="btn btn-outline-primary btn-sm"><i class="ion-md-add"></i> 添加运费模板</a>
            </div>
            <div class="col-6">
            </div>
        </div>
        <table class="table table-hover table-striped">
            ...
            <foreach name="lists" item="v">
                <tr>
                    ...
                    <td>
                        <if condition="$v['calc_type'] EQ 2">
                            <span class="badge badge-warning">按体积计算</span>
                            <elseif condition="$v['calc_type'] EQ 1"/>
