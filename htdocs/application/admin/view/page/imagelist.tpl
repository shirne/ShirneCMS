    ...
    <table class="table table-hover table-striped">
        ...
        <foreach name="lists" item="v">
            <tr>
                ...
                <td>{$v.sort}</td>
                <td>
                    <a class="btn btn-outline-dark btn-sm" href="{:url('page/imageupdate',array('id'=>$v['id'],'aid'=>$aid))}"><i class="ion-md-create"></i> 编辑</a>
                    <a class="btn btn-outline-dark btn-sm" href="{:url('page/imagedelete',array('id'=>$v['id'],'aid'=>$aid))}" onclick="javascript:return del(this,'您真的确定要删除吗？\n\n删除后将不能恢复!');"><i class="ion-md-trash"></i> 删除</a>
                </td>
            </tr>
        </foreach>
        </tbody>
