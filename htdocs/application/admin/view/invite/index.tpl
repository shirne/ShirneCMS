    ...
    <table class="table table-hover table-striped">
        ...
        <foreach name="lists" item="v">
            <tr>
                ...
                <td>
                    <a class="btn btn-default btn-sm" href="{:url('Invite/update',array('id'=>$v['id']))}"><i class="ion-edit"></i> 转赠</a>
                    ...
                    <else/>
                        <a class="btn btn-default btn-sm" href="{:url('Invite/unlock',array('id'=>$v['id']))}" style="color:#50AD1E;"><i class="ion-check"></i> 解锁</a>
                    </if>
                </td>
            </tr>
        </foreach>
