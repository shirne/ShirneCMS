...
<div id="page-wrapper">
    ...
    <div class="row list-header">
        <div class="col-6">
            <a href="{:url('shop.brand/add')}" class="btn btn-outline-primary btn-sm"><i class="ion-md-add"></i> 添加品牌</a>
        </div>
        <div class="col-6">
            <form action="{:url('shop.brand/index')}" method="post">
    ...
    <table class="table table-hover table-striped">
        ...
        <volist name="lists" id="v" empty="$empty">
            <tr>
                ...
                <td>{$v.sort}</td> 
                <td class="operations">
                    <a class="btn btn-outline-primary" title="编辑" href="{:url('shop.brand/edit',array('id'=>$v['id']))}"><i class="ion-md-create"></i> </a>
                    <a class="btn btn-outline-danger link-confirm" title="删除" data-configm="您真的确定要删除吗？\n删除后将不能恢复!" href="{:url('shop.brand/delete',array('id'=>$v['id']))}" ><i class="ion-md-trash"></i> </a>
                </td>
            </tr>
        </volist>
        </tbody>
