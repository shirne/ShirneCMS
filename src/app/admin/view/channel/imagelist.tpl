...
<div id="page-wrapper">
    ...
    <div class="row list-header">
        <div class="col-6">
            ...
            <a href="{:url('channel/imageadd',array('channel_id'=>$channel_id,'aid'=>$aid))}" class="btn btn-outline-primary btn-sm"><i class="ion-md-add"></i> 添加图片</a>
        </div>
        <div class="col-6">
    ...
    <table class="table table-hover table-striped">
        ...
        {foreach name="lists" item="v"}
            <tr>
                ...
                <td>{$v.sort}</td>
                <td class="operations">
                    <a class="btn btn-outline-primary" title="编辑" href="{:url('channel/imageupdate',array('channel_id'=>$channel_id,'id'=>$v['id'],'aid'=>$aid))}"><i class="ion-md-create"></i> </a>
