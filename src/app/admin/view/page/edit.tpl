        ...
        <div id="page-content">
            <form method="post" class="page-form" action="" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="col form-group">
<<<<<<< HEAD:src/app/admin/view/page/edit.tpl
                        <label for="page-title">副标题</label>
                        <input type="text" name="vice_title" class="form-control" value="{$page.vice_title|default=''}" id="page-title"
                               >
=======
                        <label for="vice_title">副标题</label>
                        <input type="text" name="vice_title" class="form-control" value="{$page.vice_title}"  >
>>>>>>> v2:src/application/admin/view/page/edit.tpl
                    </div>
                </div>
                <div class="form-row">
                    <div class="col form-group">
...
<<<<<<< HEAD:src/app/admin/view/page/edit.tpl
                ...
                <div class="col form-group">
                    ...
                    <input type="text" name="sort" class="form-control" value="{$page.sort|default=9}" >
                </div>
=======
>>>>>>> v2:src/application/admin/view/page/edit.tpl
                </div>
