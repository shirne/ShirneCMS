    ...
    SearchImage.prototype = {
        ...
        getImageData: function(){
            var _this = this,
                ...
                url = "//image.baidu.com/i?ct=201326592&cl=2&lm=-1&st=-1&tn=baiduimagejson&istype=2&rn=32&fm=index&pv=&word=" + key + type + "&ie=utf-8&oe=utf-8&keeporiginname=" + keepOriginName + "&" + +new Date;
                ...
                for (i = 0; i < list.length; i++) {
                    ...
                    img.onerror=(function(i){
                        return function () {
                            ...
                            // 如果https链接也获取不到，尝试代理加载，并移除onerror事件
                            this.onerror = null;
