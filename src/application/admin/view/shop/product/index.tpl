	...
	<div class="row list-header">
		<div class="col-md-6">
			<div class="btn-toolbar list-toolbar" role="toolbar" aria-label="Toolbar with button groups">
				...
				<a href="{:url('shop.product/trash')}" class="btn btn-outline-primary btn-sm"><i
			...
			<tr>
				...
				<td class="operations">
					<a class="btn btn-outline-primary" title="编辑"
						href="{:url('shop.product/edit',array('id'=>$v['id']))}"><i class="ion-md-create"></i> </a>
					<a class="btn btn-outline-primary qrcode-btn" data-id="{$v.id}" title="二维码" href="javascript:"><i
							class="ion-md-qr-scanner"></i> </a>
					<a class="btn btn-outline-primary" title="图集"
						href="{:url('shop.product/imagelist',array('aid'=>$v['id']))}"><i class="ion-md-images"></i>
					</a>
					<a class="btn btn-outline-primary" title="评论"
						href="{:url('shop.product/comments',array('aid'=>$v['id']))}"><i class="ion-md-chatboxes"></i>
					</a>
					<a class="btn btn-outline-danger link-confirm" title="删除" data-confirm="您真的确定要删除吗？\n删除后将不能恢复!"
						href="{:url('shop.product/delete',array('id'=>$v['id']))}"><i class="ion-md-trash"></i> </a>
				</td>
			</tr>
			{/volist}
		</tbody>
