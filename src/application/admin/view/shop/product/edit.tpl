                ...
                <div class="col">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="unit" class="form-control" value="{$product.unit|default=''}"
                                id="product-unit" style="max-width:50px;" placeholder="单位">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="vice_title" class="form-control"
                                value="{$product.vice_title|default=''}" id="product-vice_title" placeholder="简要概括文字">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="goods_no" class="form-control"
                                value="{$product.goods_no|default=''}" id="product-goods_no" placeholder="输入商品货号">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="cate_id" id="product-cate" class="form-control">
                                ...
                                <option value="{$v.id}" data-pid="{$v['pid']}" data-props="{$v['props']}"
                                    data-specs="{$v['specs']}" {$product['cate_id']==$v['id']?'selected':""}>{$v.html}
                                    {$v.title}</option>
                                {/foreach}
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="brand_id" id="product-brand" class="form-control">
                                ...
                                <option value="{$v.id}" {$product['brand_id']==$v['id']?'selected':""}>{$v.title}
                                </option>
                                {/foreach}
                            </select>
                        </div>
                            ...
                            <div class="form-row type_level">
                                ...
                                <div class="form-group col">
                                    <div class="btn-group btn-group-toggle btn-group-sm" data-toggle="buttons">
                                        ...
                                        <label
                                            class="btn btn-outline-secondary{if isset($product['level_id']) && $k==$product['level_id']} active{/if}">
                                            <input type="radio" name="level_id" value="{$k}" autocomplete="off" {if
                                                isset($product['level_id']) &&
                                                $k==$product['level_id']}checked{/if}>{$lv.level_name}
                                        </label>
                                        {/volist}
                                    </div>
                                </div>
                                    ...
                                    <div class="btn-group btn-group-toggle btn-group-sm commision-groups"
                                        ...
                                        <label
                                            ...
                                            <input type="radio" name="is_commission" value="1" autocomplete="off"
                                                {$product['is_commission']==1?'checked':''}>支持
                                        </label>
                                        <label
                                            ...
                                            <input type="radio" name="is_commission" value="2" autocomplete="off"
                                                {$product['is_commission']==2?'checked':''}>设置比例
                                        </label>
                                        <label
                                            ...
                                            <input type="radio" name="is_commission" value="3" autocomplete="off"
                                                {$product['is_commission']==3?'checked':''}>设置金额
                                        </label>
                                        <label
                                            ...
                                            <input type="radio" name="is_commission" value="4" autocomplete="off"
                                                {$product['is_commission']==4?'checked':''}>详细设置
                                        </label>
                                        <label
                                            ...
                                            <input type="radio" name="is_commission" value="0" autocomplete="off"
                                                {$product['is_commission']==0?'checked':''}>不支持
                                        </label>
                                    </div>
                                </div>
                            </div>

                            {php}$layercounts = array_column($levels,'commission_layer');$layercount =
                            max($layercounts);{/php}
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group mb-1 col">
                                    <div class="btn-group btn-group-toggle btn-group-sm" data-toggle="buttons">
                                        {volist name="levels" id="lv" key="k"}
                                        <label
                                            class="btn btn-outline-secondary{:fix_in_array($k,$product['levels'])?' active':''}">
                                            <input type="checkbox" name="levels[]" value="{$k}" autocomplete="off"
                                                {:fix_in_array($k,$product['levels'])?'checked':''}>{$lv.level_name}
                                        </label>
                                        {/volist}
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-1 col">
                                    <div class="input-group input-group-sm">
                                        <select name="max_buy_cycle" class="form-control">
                                            ...
                                            <option value="day" {if isset($product['max_buy_cycle']) &&
                                                $product['max_buy_cycle']=='day' }selected{/if}>每天</option>
                                            <option value="week" {if isset($product['max_buy_cycle']) &&
                                                $product['max_buy_cycle']=='week' }selected{/if}>每周</option>
                                            <option value="month" {if isset($product['max_buy_cycle']) &&
                                                $product['max_buy_cycle']=='month' }selected{/if}>每月</option>
                                            <option value="season" {if isset($product['max_buy_cycle']) &&
                                                $product['max_buy_cycle']=='season' }selected{/if}>每季</option>
                                            <option value="year" {if isset($product['max_buy_cycle']) &&
                                                $product['max_buy_cycle']=='year' }selected{/if}>每年</option>
                                        </select>
                                        <span class="input-group-middle"><span
                                                class="input-group-text">最多购买</span></span>
                                        <input type="text" name="max_buy" class="form-control"
                                            value="{$product['max_buy']|default=0}" placeholder="填写0不限制" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col">
                                    <select class="form-control form-control-sm" name="postage_id">
                                        ...
                                        {php}
                                        $selected='';
                                        if(($product['id']==0 && $pos['is_default']) ||
                                        $product['postage_id']==$pos['id']){
                                        $selected='selected';
                                        }
                                        {/php}
                                        <option value="{$pos.id}" {$selected}>{$pos.title}{$pos['is_default']?'(默认)':''}
                                        </option>
                                        {/volist}
                                    </select>
                                </div>
                ...
                <div class="form-group col">
                    <div class="spec-groups">
                        ...
                        <div class="d-flex spec-row spec-{$k}" data-specid="{$k}">
                            ...
                            <div class="form-control col"><input type="text" class="taginput" data-spec_id="{$k}"
                                    value="{:implode(',',$spec['data'])}"></div>
                            <div class="delete"><a href="javascript:" class="btn btn-outline-secondary"><i
                                        class="ion-md-trash"></i> </a> </div>
                        </div>
                        {/foreach}
                    </div>
                    <a href="javascript:" class="btn btn-outline-dark btn-sm addspecbtn"><i class="ion-md-add"></i>
                        添加规格</a>
                </div>
            </div>
            <div class="form-group">
                <table class="table table-hover spec-table">
                    ...
                    <tbody>
                        ...
                        <tr data-idx="{$k}">
                            ...
                            <td><input type="hidden" class="spec-val" data-specid="{$sk}"
                                    name="skus[{$k}][specs][{$sk}]" value="{$sku['specs'][$sk]}" />{$sku['specs'][$sk]}
                            </td>
                            {/foreach}
                            <td>
                                <input type="hidden" class="field-sku_id" name="skus[{$k}][sku_id]"
                                    value="{$sku.sku_id|default=''}" />
                                <input type="text" class="form-control field-goods_no" name="skus[{$k}][goods_no]"
                                    value="{$sku.goods_no|default=''}">
                            </td>
                            <td><input type="hidden" class="field-sku_id" name="skus[{$k}][image]"
                                    value="{$sku.image|default=''}" /><img class="imgupload rounded"
                                    src="{$sku.image|default='/static/images/noimage.png'}" /> </td>
                            <td><input type="text" class="form-control field-weight" name="skus[{$k}][weight]"
                                    value="{$sku.weight|default=''}"> </td>
                            <td><input type="text" class="form-control field-price" name="skus[{$k}][price]"
                                    value="{$sku.price|default=''}"> </td>
                            <td>
                                {if !empty($price_levels)}
                                {foreach $price_levels as $plv}
                                <div class="input-group input-group-sm"><span class="input-group-prepend"><span
                                            class="input-group-text">{$plv.level_name}</span></span><input type="text"
                                        class="form-control field-ext_price" data-level_id="{$plv.level_id}"
                                        name="skus[{$k}][ext_price][{$plv.level_id}]"
                                        value="{$sku['ext_price'][$plv['level_id']]?:''}"></div>
                                {/foreach}
                                {else/}
                                -
                                {/if}
                            ...
                            <td><input type="text" class="form-control field-market_price"
                                    name="skus[{$k}][market_price]" value="{$sku.market_price|default=''}"> </td>
                            <td><input type="text" class="form-control field-cost_price" name="skus[{$k}][cost_price]"
                                    value="{$sku.cost_price|default=''}"> </td>
                            <td><input type="text" class="form-control field-storage" name="skus[{$k}][storage]"
                                    value="{$sku.storage|default=''}"> </td>
