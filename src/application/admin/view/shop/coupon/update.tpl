    ...
    <form method="post" class="page-form" action="">
        ...
        <div class="form-group cptype cptype_0">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="amount" value="{$model.amount|default=''|number_empty}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-row date-range">
                <div class="input-group col">
                    ...
                    <input type="text" name="start_time" class="form-control fromdate" value="{$model.start_time|default='0'|showdate=''}" />
                </div>
                <div class="input-group col">
                    <div class="input-group-prepend">
                        <span class="input-group-text">至</span>
                    </div>
                    <input type="text" name="end_time" class="form-control todate" value="{$model.end_time|default='0'|showdate=''}" />
                </div>
            </div>
        </div>
        ...
        <div class="form-group exptype exptype_1">
            ...
            <div class="input-group">
                <input type="text" class="form-control datepicker"  name="expiry_time" value="{$model.expiry_time|default=0|showdate}">
                <div class="input-group-append">
