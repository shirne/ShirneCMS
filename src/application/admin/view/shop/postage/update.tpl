                                    ...
                                    <div class="col">
                                        <div class="btn-group btn-group-toggle" >
                                            <label :class="'btn btn-outline-primary '+(postage.is_default==1?'active':'')">
                                                <input type="radio" name="is_default" :value="1" v-model="postage.is_default"
                                                       autocomplete="off" > 是
                                            </label>
                                            <label :class="'btn btn-outline-secondary '+(postage.is_default==0?'active':'')">
                                                <input type="radio" name="is_default" :value="0" v-model="postage.is_default"
                                                       autocomplete="off" > 否
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="card mt-3">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(area,idx) in areas" :key="idx">
                                    ...
                                    <td width="100">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][first]'" v-model="area.first">
                                    </td>
                                    <td width="100">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][first_fee]'" v-model="area.first_fee">
                                    </td>
                                    <td width="100">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][extend]'" v-model="area.extend">
                                    </td>
                                    <td width="100">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][extend_fee]'" v-model="area.extend_fee">
                                    </td>
                                    <td width="100">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][ceiling]'" v-model="area.ceiling">
                                    </td>
                                    <td width="120">
                                        <input type="text" class="form-control" :name="'areas['+area.id+'][free_limit]'" v-model="area.free_limit">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col">
                            <div class="text-muted">1. 配送区域不设置默认不限制区域，设置了区域则仅在设置的区域内可用。如果匹配不到可用区域，使用本模板的产品将不可购买<br />2. 不填写(或0)封顶和免运费额度则运费根据货品一直累加<br />3. 计算运费时优先匹配设置的地区，若有匹配到地区则忽略未匹配到地区的。若有多个地区同时满足，则显示选项给用户选择</div>
                            </div>
                        </div>
                    </div>
                </div>
