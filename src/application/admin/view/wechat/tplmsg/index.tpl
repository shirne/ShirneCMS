    ...
    <form action="" method="post">
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>{$tpls[$key]['id']}</td>
                    <td><input type="text" class="form-control" name="tpls[{$key}][title]" readonly
                            value="{$tpls[$key]['title']}" /></td>
                    <td>{$key}</td>
                    <td><input type="text" class="form-control" name="tpls[{$key}][template_id]"
                            value="{$tpls[$key]['template_id']}" /></td>
                    <td><input type="text" class="form-control" name="tpls[{$key}][keywords]" readonly
                            value="{$tpls[$key]['keywords']}" /></td>
                    <td class="operations">
                        <a class="btn btn-outline-danger delbtn" href="{:url('del',['id'=>$tpls[$key]['id']])}"
                            title="删除模板"><i class="ion-md-trash"></i></a>
                    </td>
                </tr>
                {else/}
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="tpls[{$key}][keywords]" readonly
                            value="{$v['keywords']}" /></td>
                    <td class="operations">
                        <a class="btn btn-outline-primary addbtn" href="{:url('add',['id'=>$v['tid']])}" title="添加模板"><i
