...
<include file="public/bread" menu="product_coupon_index" title="优惠券领取列表" />
...
<div id="page-wrapper">
    ...
    <div class="row list-header">
        ...
        <div class="col-6">
            <form action="{:url('productCoupon/itemlist')}" method="post">
    ...
    <table class="table table-hover table-striped">
        ...
        <foreach name="lists" item="v">
            <tr>
                ...
                <td class="operations">
                    <a class="btn btn-outline-danger link-confirm" title="删除" data-confirm="您真的确定要删除吗？\n\n删除后将不能恢复!" href="{:url('productCoupon/itemdelete',array('id'=>$v['id'],'gid'=>$gid))}" ><i class="ion-md-trash"></i> </a>
                </td>
            </tr>
        </foreach>
        </tbody>
