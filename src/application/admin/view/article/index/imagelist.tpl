...
<div id="page-wrapper">
    ...
    <div class="row list-header">
        <div class="col-6">
            <a href="{:url('article.index/index')}" class="btn btn-outline-primary btn-sm"><i
                    class="ion-md-arrow-back"></i> 返回列表</a>
            <a href="{:url('article.index/imageadd',array('aid'=>$aid))}" class="btn btn-outline-primary btn-sm"><i
                    class="ion-md-add"></i> 添加图片</a>
        </div>
        <div class="col-6">
            <form action="{:url('article.index/imagelist')}" method="post">
            ...
            <tr>
                ...
                <td class="operations">
                    <a class="btn btn-outline-primary" title="编辑"
                        href="{:url('article.index/imageupdate',array('id'=>$v['id'],'aid'=>$aid))}"><i
                            class="ion-md-create"></i> </a>
                    <a class="btn btn-outline-danger link-confirm" title="删除" data-confirm="您真的确定要删除吗？\n删除后将不能恢复!"
                        href="{:url('article.index/imagedelete',array('id'=>$v['id'],'aid'=>$aid))}"><i
