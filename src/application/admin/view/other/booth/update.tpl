        ...
        <form method="post" class="page-form" action="">
            <div class="form-row">
                ...
                <div class="form-group col">
                    ...
                    <input type="text" name="flag" class="form-control" :readonly="model.locked==1" v-model="model.flag"
                        placeholder="调用标识">
                </div>
            </div>
            <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            <div class="btn-group btn-group-toggle">
                                <label :class="'btn btn-outline-secondary'+(model.data.type==0?' active':'')">
                                    <input type="radio" name="data[type]" :value="0" autocomplete="off"
                                        v-model="model.data.type">自动获取
                                </label>
                                <label :class="'btn btn-outline-secondary'+(model.data.type==1?' active':'')">
                                    <input type="radio" name="data[type]" :value="1" autocomplete="off"
                                        v-model="model.data.type">手动选择
                                </label>
                            </div>
                        </div>
                        <div v-show="model.data.type==0" class="form-group col">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="data[article_count]"
                                    v-model="model.data.article_count" />
                                <span class="input-group-middle"><span class="input-group-text">排序</span> </span>
                                <select class="form-control" v-model="model.data.article_sort"
                                    name="data[article_sort]">
                    ...
                    <div v-show="model.data.type==1" class="form-row">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="media" @click="pickCate">
                                <i class="ion-md-add border"
                                    style="font-size: 60px;line-height:1em;width:60px;text-align: center"></i>
                        ...
                        <div class="form-group col">
                            <div class="btn-group btn-group-toggle">
                                <label :class="'btn btn-outline-secondary'+(model.data.filter_type?'':' active')">
                                    <input type="radio" name="data[filter_type]" value=""
                                        v-model="model.data.filter_type" autocomplete="off">不限
                                </label>
                                {volist name="article_types" id="type" key="k"}
                                <label
                                    :class="'btn btn-outline-secondary'+(model.data.filter_type=={$key}?' active':'')">
                                    <input type="radio" name="data[filter_type]" :value="{$key}"
                                        v-model="model.data.filter_type" autocomplete="off">{$type}
                                </label>
                                {/volist}
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div v-show="model.data.type==0" class="form-group col">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="data[product_count]"
                                    v-model="model.data.product_count" />
                                <span class="input-group-middle"><span class="input-group-text">排序</span> </span>
                                <select class="form-control" v-model="model.data.product_sort"
                                    name="data[product_sort]">
                                    <option value="">默认排序</option>
                                    <option value="update_time desc">更新时间</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="data[ad_flag]"
                                    v-model="model.data.ad_flag" />
                                <span class="input-group-append"><button class="btn btn-outline-primary"
                                        @click="pickAd"><i class="ion-md-search"></i> </button> </span>
                            </div>
                        </div>
                        <div class="form-group col">
                            <div class="input-group">
