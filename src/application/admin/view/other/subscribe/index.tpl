...
<div id="page-wrapper">
    ...
    <div class="row list-header">
        <div class="col-6">
            <a href="javascript:" class="btn btn-outline-primary btn-sm btn-add-subscribe"><i class="ion-md-add"></i>
                添加订阅</a>
        </div>
        <div class="col-6">
            <form action="{:url('other.subscribe/index')}" method="post">
            ...
            <tr>
                ...
                <td class="operations">
                    ...
                    <a class="btn btn-outline-danger link-confirm" title="删除" data-configm="您真的确定要删除吗？\n删除后将不能恢复!"
                        href="{:url('other.subscribe/delete',array('id'=>$v['id']))}"><i class="ion-md-trash"></i> </a>
                </td>
            </tr>
            {/volist}
        </tbody>
