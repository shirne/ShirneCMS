...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" role="navigation">
            ...
            <a class="navbar-brand text-light" href="{:url('index/index')}"><i class="ion-md-speedometer"></i>
                {:lang('Management')}</a>
            ...
            <div class="collapse navbar-collapse justify-content-end navbar-ex1-collapse" id="navbarSupportedContent">
                ...
                <div class="nav navbar-nav navbar-user">
                    <li class="dropdown user-dropdown">
                        <a href="javascript:" class="nav-link" data-toggle="dropdown"><i
                                class="ion-md-notifications"></i></a>
                        <div class="dropdown-menu">
                            <span class="dropdown-item">暂无提醒</span>
                        </div>
                    </li>
                    <li class="dropdown user-dropdown">
                        <a href="javascript:" class="nav-link dropdown-toggle" data-toggle="dropdown"><i
                                class="ion-md-person"></i> {:lang('Welcome %s',[session('adminname')])} <b
                                class="caret"></b></a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/" target="_blank"><i class="ion-md-home"></i> {:lang('Home
                                ')}</a>
                            <a class="dropdown-item" href="{:url('index/clearcache')}"><i class="ion-md-sync"></i>
                                {:lang('Clear Cache')}</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{:url('setting/index')}"><i class="ion-md-options"></i>
                                {:lang('Settings')}</a>
                            <a class="dropdown-item" href="{:url('index/profile')}"><i class="ion-md-person"></i>
                                {:lang('Profile')}</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{:url('login/logout')}"><i class="ion-md-log-out"></i>
                                {:lang('Sign out')}</a>
                        </div>
                    </li>
                    </ul>
