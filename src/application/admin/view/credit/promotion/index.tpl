...
<block name="body">
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-row form-group">
            <label for="v-credit_close_desc" class="form-label w-100px text-right align-middle">{$setting['credit_close_desc']['title']}</label>
            <div class="col-5">
                <div class="input-group">
                    <input type="text" class="form-control" name="v-credit_close_desc" value="{$setting['credit_close_desc']['value']}" placeholder="">
                </div>
            </div>
            <div class="col">
