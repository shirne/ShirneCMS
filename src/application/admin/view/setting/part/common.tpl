<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-webname" value="{$setting['site-webname']['value']}"
            placeholder="站点名">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-keywords" value="{$setting['site-keywords']['value']}"
            placeholder="关键词">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-description"
            value="{$setting['site-description']['value']}" placeholder="站点描述">
    </div>
</div>
<div class="form-row form-group">
...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <textarea name="v-site-tongji" class="form-control"
            placeholder="统计代码">{$setting['site-tongji']['value']}</textarea>
    </div>
</div>
<div class="form-row form-group">
    <label for="v-site-icp" class="col-3 col-md-2 text-right align-middle">ICP备案号</label>
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-icp" value="{$setting['site-icp']['value']}"
            placeholder="ICP备案号">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-gongan-icp" value="{$setting['gongan-icp']['value']}"
            placeholder="公安备案号">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-url" value="{$setting['site-url']['value']}"
            placeholder="站点地址">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-name" value="{$setting['site-name']['value']}"
            placeholder="公司名">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-400" value="{$setting['site-400']['value']}"
            placeholder="400电话">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-telephone" value="{$setting['site-telephone']['value']}"
            placeholder="联系电话">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-email" value="{$setting['site-email']['value']}"
            placeholder="公司邮箱">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <input type="text" class="form-control" name="v-site-address" value="{$setting['site-address']['value']}"
            placeholder="公司地址">
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="input-group">
            <input type="text" class="form-control" name="v-site-location" value="{$setting['site-location']['value']}"
