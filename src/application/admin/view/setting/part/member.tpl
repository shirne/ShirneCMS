...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            {foreach $setting['autoaudit']['data'] as $k => $value}
            {if $k==$setting['autoaudit']['value']}
            <label class="btn btn-outline-secondary active">
...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="input-group">
            <input type="text" class="form-control" name="v-referer_id"
                value="{$setting['referer_id']['value']|default=''}" placeholder="推荐人ID">
...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle mregopengroup" data-toggle="buttons">
            {foreach $setting['agent_lock']['data'] as $k => $value}
            {if $k==$setting['agent_lock']['value']}
            <label class="btn btn-outline-secondary active">
...
<div class="form-row form-group">
    <label for="v-commission_type"
        class="col-3 col-md-2 text-right align-middle">{$setting['commission_type']['title']}</label>
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            {foreach $setting['commission_type']['data'] as $k => $value}
            {if $k==$setting['commission_type']['value']}
            <label class="btn btn-outline-secondary active">
...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            {foreach $setting['agent_start']['data'] as $k => $value}
            {if $k==$setting['agent_start']['value']}
            <label class="btn btn-outline-secondary active">
...
<div class="form-row form-group">
    <label for="v-commission_delay"
        class="col-3 col-md-2 text-right align-middle">{$setting['commission_delay']['title']}</label>
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            {foreach $setting['commission_delay']['data'] as $k => $value}
            {if $k==$setting['commission_delay']['value']}
            <label class="btn btn-outline-secondary active">
...
<div class="form-row form-group">
    <label for="v-commission_delay_days"
        class="col-3 col-md-2 text-right align-middle">{$setting['commission_delay_days']['title']}</label>
    <div class="col-9 col-md-8 col-lg-6">
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">达到发放时间后</span>
            </div>
            <input type="text" class="form-control" name="v-commission_delay_days"
                value="{$setting['commission_delay_days']['value']}" placeholder="">
            <div class="input-group-append">
...
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            {foreach $setting['cash_types']['data'] as $k => $value}
            {if in_array($k,$setting['cash_types']['value'])}
            <label class="btn btn-outline-secondary active">
        ...
        <div>
            <div class="text-muted">
                企业付款、微信红包、小程序红包，需要在微信支付中开通对应的功能才可以启用。<br />微信红包、小程序红包限额200,日限额10个/1000元。<br />支付商户开通条件：1、入驻时间超过90天
                2、连续正常交易30天。</div>
        </div>
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="v-cash_limit" value="{$setting['cash_limit']['value']}"
                placeholder="">
            <div class="input-group-middle">
                <span class="input-group-text">最高</span>
            </div>
            <input type="text" class="form-control" name="v-cash_max" value="{$setting['cash_max']['value']}"
                placeholder="">
            <div class="input-group-middle">
                <span class="input-group-text">金额倍数</span>
            </div>
            <input type="text" class="form-control" name="v-cash_power" value="{$setting['cash_power']['value']}"
                placeholder="">
        </div>
    </div>
</div>
<div class="form-row form-group">
    ...
    <div class="col-9 col-md-8 col-lg-6">
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="v-cash_fee" value="{$setting['cash_fee']['value']}"
                placeholder="">
            <div class="input-group-middle">
                <span class="input-group-text">% 最低</span>
            </div>
            <input type="text" class="form-control" name="v-cash_fee_min" value="{$setting['cash_fee_min']['value']}"
                placeholder="">
            <div class="input-group-middle">
                <span class="input-group-text">封顶</span>
            </div>
            <input type="text" class="form-control" name="v-cash_fee_max" value="{$setting['cash_fee_max']['value']}"
                placeholder="">
        </div>
    </div>
</div>