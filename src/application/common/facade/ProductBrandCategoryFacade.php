...
/**
 * Class ProductBrandCategoryFacade
 * @package app\common\facade
 * @see \app\common\model\ProductBrandCategoryModel
 ...
 */
class ProductBrandCategoryFacade extends SimpleFacade
{
    protected static function getFacadeClass()
    {
        return \app\common\model\ProductBrandCategoryModel::class;
    }
}
