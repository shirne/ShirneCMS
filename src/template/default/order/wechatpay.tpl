...
<div class="card">
    ...
    <div class="card-body" style="padding-bottom:80px;">
        <div class="pay_amount" style="padding:20px;text-align: center;color: #222;font-size:18px;">
            付款金额：{$payorder['pay_amount']|showmoney}</div>
        <div class="weui-btn-area" style="margin:50px;">
            ...
            {else/}
            <a href="{:url('index/member.order/detail',['id'=>$payorder['order_id']])}"
                class="btn btn-block btn-secondary orderlink">查看订单</a>
            {/if}
        </div>
    </div>
</div>
        ...
        WeixinJSBridge.invoke(
            ...
            function (res) {
                if (res.err_msg == "get_brand_wcpay_request:ok") {
                    ...
                    dialog.alert(res.err_desc || res.err_msg || res.errMsg);
                }
            });
    }
