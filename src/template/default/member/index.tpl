...
<div class="container user-index">
    <div class="text-center user-header">
        ...
        <div class="row inforow">
            <div class="col-3">
                <p>消费积分</p>
                <p>￥{$user.money|showmoney}</p>
            </div>
            <div class="col-3">
                <p>已提现</p>
                <p>￥{$totalCash|showmoney}</p>
            </div>
            <div class="col-3">
                <p>总收益</p>
                <p>￥{$totalAward|showmoney}</p>
            </div>
            <div class="col-3">
                <p>现金积分</p>
                <p>￥{$user.credit|showmoney}</p>
            </div>
        </div>
    </div>
    ...
    <div class="list-group">
        ...
        <a class="list-group-item" href="{:aurl('index/member.account/cashList')}"><i class="ion-md-reorder"></i>
            提现记录</a>
        <a class="list-group-item" href="{:aurl('index/member.account/cash')}"><i class="ion-md-cash"></i> 我要提现</a>
        <a class="list-group-item" href="{:aurl('index/member.account/rechargeList')}"><i class="ion-md-reorder"></i>
            充值记录</a>
