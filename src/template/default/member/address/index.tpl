...
<div class="container">
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-8 mt-3 mb-2 text-right"><a class="btn btn-outline-primary btn-confirm"
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            ...
            <div class="order-btns text-right">
                <a class="btn btn-outline-secondary btn-confirm"
                    href="{:aurl('index/member.address/add',array('id'=>$v['address_id']))}">编辑</a>
            </div>
        </li>
        {/foreach}
    </ul>
