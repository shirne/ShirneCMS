						...
						<form class="form-horizontal" role="form" method="post" action="{:url('index/login/index')}">
								...
								<div class="row">
									...
									<div class="col">
										...
										<p style="font-size: 13px;color: #888888;">
											{:lang('Bind to this wechat after sign in')}
										</p>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<div class="input-group-append">
										<a href="javascript:" class="input-group-text verifybox" style="padding:0;"><img
												src="{:url('index/login/verify')}" alt=""></a>
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="text-center">
									{:lang('No account yet?')}<a class="text-info pl-2"
										href="{:url('index/login/register')}">{:lang('Create an account')}</a>
								</div>
							</div>
						</form>
