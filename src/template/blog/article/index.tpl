        ...
        <div class="row">
            <div class="col-lg-9">
                <ul class="list-group article-list">
                    {php}$empty='<li class="list-group-item empty-box">
                        <p class="empty">暂时没有内容</p>
                    </li>';{/php}
                    {volist name="lists" id="art" empty="$empty"}
                    <li class="list-group-item">
                        {if !empty($art['cover'])}
                        <a class="list-img" href="{:url('index/article/view',['id'=>$art['id']])}"
                        ...
                        <div class="art-view">
                            ...
                            <div class="text-muted">
                                <a href="{:url('index/article/index',['name'=>$art['category_name']])}"><span
                                        class="badge badge-secondary">{$art.category_title}</span></a>
                                ...
                                <span class="ml-2" data-anchor="comment"><i class="ion-md-text"></i>
                                    {$art.comment}</span>
                            </div>
                        </div>
                    </li>
